                            ...
                            <FormItem className='w-full'>
                                ...
                                <FormControl>
                                    <div className='relative'>
                                        ...
                                        <Button className='bg-gray-500 hover:bg-gray-600 text-white px-4 py-1 mt-2' type='button'
                                            onClick={() => (
                                        ...
                                        <div className="flex-start space-x-3">
                                            {images.map((image: string) => (
                                                <Image key={image}
                                                    src={image}
                                                    alt='product image'
                                                    className='w-20 h-20 objectc] object-center rounded-sm'
                                                    height={100}
                                                    width={100}></Image>
